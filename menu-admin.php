<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"> 
              ...
              <ul class="treeview-menu">
                <li><a href="index.php?view=Santri"><i class="fa fa-circle-o"></i> Data Santri</a></li>
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=absenSantri"><i class="fa fa-circle-o"></i> Absensi Santri</a></li>
                <li><a href="index.php?view=rekapabsenSantri"><i class="fa fa-circle-o"></i> Rekap Absensi Santri</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="index.php?view=psbsma"><i class="fa fa-circle-o"></i> Data Pendaftar TK</a></li>
